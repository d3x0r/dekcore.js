		...
		if( shabuf ) {
			...
			if( RNG.saltbuf.length ) {
				...
				newbuf = toUTF8Array( RNG.saltbuf.join() );
	                        newbuf = RNG.entropy.concat( newbuf ); 
